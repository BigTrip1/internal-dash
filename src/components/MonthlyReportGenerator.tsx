      ...
      <div className="relative">
        ...
        <div className="space-y-4">
          ...
          <div className="text-xs text-gray-400 bg-gray-800/30 rounded p-3 border border-gray-700">
            <strong>Instructions:</strong> Click "Preview Report" to open the full-width report in a new tab, then use "Download PDF" to create a PDF for email distribution. The report includes glide path calculations showing the monthly DPU reduction targets needed to achieve the 8.2 year-end goal.
          </div>
        </div>
      </div>
    </div>
